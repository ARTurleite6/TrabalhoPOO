...
public class Teste {
    public static void main(String[] args) {
        Fatura f = new Fatura("EDP", "256250278", 200, 150, LocalDate.now().minusDays(1), LocalDate.now());
        Fatura f2 = new Fatura("Endesa", "256250270", 150, 100, LocalDate.now().minusDays(1), LocalDate.now());
